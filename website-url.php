...
<html lang="en">
	<head>
		...
		<title> Quick qr code generator for website url and download QR image free | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="Quick , qr code, generator , website, url, download, qr image, free, qr setup"/>
		<meta name="description" content="This online QR code generator is a simple and free tool to create unlimited QR code for website url, social website, blog website can download it free in the format of an image.Generated QR code has no expiry date. No sign-up required ."/>
		...
		<meta name="url" content="https://qr-setup.com/website-url.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/website-url.php">
	...
	<body onload="start()">
		...
		<div class="nav">
			<div class="links">
				<a onclick="website(this)" id="website" class="active">Website URL</a>
		 ...
		 <script type="text/javascript">
			...
			function start(){
				var codeBlock='<div class="head">'+
						'<i class="icon fa fa-file-text-o" aria-hidden="true"></i><b class="head-text">   Website URL</b>'+
						
					'</div>'+
					'<div class="url-input">'+
						'<input class="url" type="text" name="simpleurl" id="simpleurl" placeholder="https://qrsetup.com/" autocomplete="off" required="required">'+
					'</div>'+
					'<div class="error-message-div">'+
					     '<span class="error-message" id="error-message-name"></span>'+
                    '</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="website-url" onclick="websiteUrl_validate()"/>'+
					'</div>';
