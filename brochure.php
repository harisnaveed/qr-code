...
<html lang="en">
	<head>
		...
		<meta name="url" content="https://qr-setup.com/brochure.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/brochure.php">
                ...
                document.getElementById("demo").style.display = "none";
                   document.getElementById("form").style.display = "block";
                     var codeBlock='<div class="head">'+
						'<i class="icon fa fa-file-text-o" aria-hidden="true"></i><b class="head-text">   Brochure</b>'+
						
					'</div>'+
					'<div class="packaging-div">'+
							'<label class=" add-title-label">Title of Advertisement:</label>'+
							'<input class="add-title-input" type="text" name="brochure_title" id="brochure_title" placeholder="Planet fitness, subway"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-brochure-title"></span>'+
                            '</div>'+
							
							'<label class=" add-heading1-label">Heading 1:</label>'+
							'<input class="add-heading1-input" type="text" name="brochure_h1" id="brochure_h1" placeholder="Eating fresh"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-brochure-h1"></span>'+
                            '</div>'+
							
							'<label class=" add-heading2-label">Heading 2:</label>'+
							'<input class="add-heading2-input" type="text" name="brochure_h2" id="brochure_h2" placeholder="train hard"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-brochure-h2"></span>'+
                            '</div>'+
							
							'<label class=" add-budget-label"> Budget Detail:</label>'+
							'<input class="add-budget-input" type="text" name="brochure_budget" id="brochure_budget" placeholder="Enter the Budget detail"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-brochure-detail"></span>'+
                            '</div>'+
							
					'</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="business_brochure" onclick="brochure_validate()"/>'+
					'</div>';
