...
<html lang="en">
	<head>
		...
		<title> How to generate unlimited free qr code for coupons and download free QR image | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="Generate,unlimited,free qr code,coupons, download ,free qr image,  QR-setup"/>
		<meta name="description" content="Qr setup provides you with the Best generator to create QR code for couption. You can Just enter your data and your QR code is ready to download a QR image  .you can use this QR code anywhere any time. The whole process is not required to sign up and sign in."/>
		...
		<meta name="url" content="https://qr-setup.com/coupon.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/coupon.php">
        ...
        function start(){
                 document.getElementById("demo").style.display = "none";
                   ...
                   var codeBlock='<div class="head">'+
						'<i class="icon fa fa-cc" aria-hidden="true"></i><b class="head-text">   Coupon Code</b>'+
						
					'</div>'+
					'<div class="packaging-div">'+
							'<label class=" coupon-title-label">Title of Coupon:</label>'+
							'<input class="coupon-title-input" type="text" name="coupon_title" id="coupon_title" placeholder="Enter title of the Coupon"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-coupon-title"></span>'+
                            '</div>'+
							
							'<label class=" coupon-code-label">Coupon Code:</label>'+
							'<input class="coupon-code-input" type="text" name="coupon_code" id="coupon_code" placeholder="Enter Coupon Code"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-coupon-code"></span>'+
                            '</div>'+
							
							'<label class=" coupon-expiry-label">Expiry Date:</label>'+
							'<input class="coupon-expiry-input" type="text" name="coupon-expiry" id="coupon_expiry" placeholder="Enter expiry date for coupon"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-coupon-date"></span>'+
                            '</div>'+
							
					'</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="business_coupon" onclick="coupon_validate()"/>'+
					'</div>';
