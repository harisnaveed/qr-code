...
<html lang="en">
	<head>
		...
		<title> QR-setup | How to set up online static QR code for SMS and download QR image free</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="QR-setup , How to, set up, online, static QR code, SMS ,download ,QR image free"/>
		<meta name="description" content="Create custom QR code to encode SMS information. This online QR code generator is free to create QR code and download QR image free.No sign up require.You are three steps away to generate your QR code ."/>
		...
		<meta name="url" content="https://qr-setup.com/sms.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/sms.php">
	...
	<body onload="start()">
		...
		<div class="nav">
			<div class="links">
				...
				<a onclick="sms(this) " id="s-m-s" class="active">SMS</a>
		...
		<script type="text/javascript">
            ...
            function start(){
              var codeBlock='<div class="head">'+
							'<i class="icon fa fa-commenting-o" aria-hidden="true"></i><b class="head-text">   SMS</b>'+
							
					'</div>'+
					'<div class="url-input">'+

					        '<input class="url" type="text" name="phone" id="phone" placeholder="Format: +923001212121" autocomplete="off" required="required">'+
					        '<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-phone"></span>'+
                            '</div>'+

							'<textarea class="url mt-3" type="text" name="sms" id="sms" placeholder="Enter your SMS" rows="7" cols="100" autocomplete="off" required="required"></textarea>'+
							// '<div class="error-message-div">'+
					          //  '<span class="error-message" id="error-message-name"></span>'+
                            //    '</div>'+
					'</div>'+
					'<div class="generate-btn-div">'+
							'<input class="generate-btn" type="submit" value="Generate Qr Code" name="contact_sms" onclick="phone_validate()"/>'+
					'</div>';
