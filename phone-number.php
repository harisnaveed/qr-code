...
<html lang="en">
	<head>
        ...
        <title> How to Convert online Personal phone number into free static QR code  | QR-setup</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="How to , convert , online, personal phone number, static qr code free, qr setup"/>
		<meta name="description" content="QR SETUP offers you to Generate your static Qr code for your phone number and download images freely.You can also convert your personal contact information into Qr code.This QR code is free for everyone and you can use it anywhere."/>
		...
		<meta name="url" content="https://qr-setup.com/phone-number.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/phone-number.php">
	...
	<body onload="start()">
		<nav id="navbar"class="navbar navbar1 navbar-expand-lg bg-white my-3">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a href="generate-qr-code.php" class="nav-btn" alt="Logo" >Generate Qr</a>
				</li>
		    </ul>
		...
		<div class="nav">
			<div class="links">
				...
				<a onclick="ph_no(this) " id="ph-no" class="active">Phone</a>
		...
		<script type="text/javascript">
            ...
            function start(){
              var codeBlock='<div class="head">'+
							'<i class="icon fa fa-phone-square" aria-hidden="true"></i><b class="head-text">   Phone</b>'+
					...
					'<div class="generate-btn-div">'+
							'<input class="generate-btn" type="submit" value="Generate Qr Code" name="contact_phone" onclick="phone_validate()"/>'+
					'</div>';
