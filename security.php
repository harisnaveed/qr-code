...
<html lang="en">
	<head>
		...
		<title> How to design online qr code for security and download QR image free | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="How to, design, unlimited,qr code,security,download, free QR image, qr setup ,online"/>
		...
		<meta name="url" content="https://qr-setup.com/security.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/security.php">
            ...
            <?php
                ...
                if(isset($_GET['value'])){
                   $value=$_GET['value'];
                    ...
                    { ?>
                    var x=document.getElementById("discounts");	
                    discounts(x);
                    <?php }
