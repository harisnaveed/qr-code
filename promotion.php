...
<html lang="en">
	<head>
		...
		<meta name="url" content="https://qr-setup.com/promotion.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/promotion.php">
                ...
                document.getElementById("demo").style.display = "none";
                   document.getElementById("form").style.display = "block";
                    var codeBlock='<div class="head">'+
						'<i class="icon fa fa-file-text-o" aria-hidden="true"></i><b class="head-text">   Promotion</b>'+
						
					'</div>'+
					'<div class="packaging-div">'+
							'<label class=" add-title-label">Title of Advertisement:</label>'+
							'<input class="add-title-input" type="text" name="promotion_title" id="promotion_title" placeholder="Planet fitness, subway"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-promotion-title"></span>'+
                            '</div>'+
							
							'<label class=" add-heading1-label">Heading 1:</label>'+
							'<input class="add-heading1-input" type="text" name="promotion_h1" id="promotion_h1" placeholder="Eating fresh"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-promotion-h1"></span>'+
                            '</div>'+
							
							'<label class=" add-heading2-label">Heading 2:</label>'+
							'<input class="add-heading2-input" type="text" name="promotion_h2" id="promotion_h2" placeholder="Train hard"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-promotion-h2"></span>'+
                            '</div>'+
							
							'<label class=" add-budget-label"> Budget Detail:</label>'+
							'<input class="add-budget-input" type="text" name="promotion_budget" id="promotion_budget" placeholder="Enter the Budget detail"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-promotion-detail"></span>'+
                            '</div>'+
							
					'</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="business_promotion" onclick="promotion_validate()"/>'+
					'</div>';
