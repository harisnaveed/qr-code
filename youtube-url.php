...
<html lang="en">
	<head>
		...
		<title> Quick Online QR code creator for youtube url and download qr image free | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="Qr code , online, creator, youtube,url, download, qr image,free,qr setup"/>
		<meta name="description" content="This online QR code generator is a simple and free tool to create unlimited QR code for youtube url.it can be downloaded free in the format of an image.Generated QR code has no expiry date. No sign-up required for the whole process"/>
		...
		<meta name="url" content="https://qr-setup.com/youtube-url.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/youtube-url.php">
	...
	<body onload="start()">
		...
		<div class="nav">
			<div class="links">
				...
				<a onclick="youtube(this)" id="youtube" class="active">Youtube URL</a>
		 ...
		 <script type="text/javascript">
			...
			function start(){
				var codeBlock='<div class="head">'+
						// '<img src="icons/youtube.png" ><b>   Youtube URL</b></i>'+
						'<i class="icon fa fa-youtube-play" aria-hidden="true"></i><b class="head-text">   Youtube URL</b>'+
						
					'</div>'+
					'<div class="url-input">'+
						'<input class="url" type="text" name="simpleurl" id="simpleurl" placeholder="https://youtube.com/" autocomplete="off" required="required">'+
					'</div>'+
					'<div class="error-message-div">'+
					     '<span class="error-message" id="error-message-name"></span>'+
                    '</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="youtube-url" onclick="youtube_validate()"/>'+
					'</div>';
