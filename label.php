...
<html lang="en">
	<head>
		...
		<title> How to Create free qr code for brochure flyers banners label & poster and download QR image free | QR-setup </title>
		...
		<meta name="url" content="https://qr-setup.com/label.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/label.php">
        ...
        function start(){
                document.getElementById("demo").style.display = "none";
                   ...
                   var codeBlock='<div class="head">'+
						'<i class="icon fa fa-file-text-o" aria-hidden="true"></i><b class="head-text">   Label</b>'+
						
					'</div>'+
					'<div class="packaging-div">'+
							'<label class=" add-title-label">Title of Advertisement:</label>'+
							'<input class="add-title-input" type="text" name="label_title" id="label_title" placeholder="Planet fitness, subway"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-label-title"></span>'+
                            '</div>'+
							
							'<label class=" add-heading1-label">Heading 1:</label>'+
							'<input class="add-heading1-input" type="text" name="label_h1" id="label_h1" placeholder="train hard"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-label-h1"></span>'+
                            '</div>'+
							
							'<label class=" add-heading2-label">Heading 2:</label>'+
							'<input class="add-heading2-input" type="text" name="label_h2" id="label_h2" placeholder="Eating fresh"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-label-h2"></span>'+
                            '</div>'+
							
							'<label class=" add-budget-label"> Budget Detail:</label>'+
							'<input class="add-budget-input" type="text" name="label_budget" id="label_budget" placeholder="Enter the Budget detail"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-label-detail"></span>'+
                            '</div>'+
							
					'</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="business_label" onclick="label_validate()"/>'+
					'</div>';
