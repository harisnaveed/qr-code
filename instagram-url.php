...
<html lang="en">
	<head>
		...
		<title> How to generate Online QR code for instagram url and download qr image free | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="How to , generate , online, qr code, instagram url, download, qr image free"/>
		<meta name="description" content="This online QR code generator is a simple and free tool to create unlimited QR code for instagram url.it can be downloaded free in the format of an image.Generated QR code has no expiry date. No sign-up required for the whole process."/>
		...
		<meta name="url" content="https://qr-setup.com/instagram-url.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/instagram-url.php">
	...
	<body onload="start()">
		...
		<div class="nav">
			<div class="links">
				...
				<a onclick="instagram(this)" id="instagram" class="active">Instagram URL</a>
		 ...
		 <script type="text/javascript">
			...
			function start(){
				var codeBlock='<div class="head">'+
						'<i class="icon fa fa-instagram" aria-hidden="true"></i><b class="head-text">   Instagram URL</b>'+
						
					'</div>'+
					'<div class="url-input">'+
						'<input class="url" type="text" name="simpleurl" id="simpleurl" placeholder="https://instagram.com/" autocomplete="off" required="required">'+
					'</div>'+
					'<div class="error-message-div">'+
					     '<span class="error-message" id="error-message-name"></span>'+
                    '</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="instagram-url" onclick="instagram_validate()"/>'+
					'</div>';
