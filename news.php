...
<html lang="en">
	<head>
		...
		<title> How to Create quick online qr code for news and download free QR Image | QR-setup </title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="keywords" content="Create,quick,online,create qr code , maker, create static qr code News, qr image"/>
		<meta name="description" content="Qr setup provides you the Best generator to create QR code for news. You can Just enter your data and your QR code is ready to download the QR image  .you can use this QR code anywhere any time. The whole process is not required to sign up and sign in."/>
		...
		<meta name="url" content="https://qr-setup.com/news.php">
		<meta name="owner" content="QR-Setup">
		<meta name="Classification" content="Business">
		<link rel="canonical" href="https://qr-setup.com/news.php">
	...
	<body onload="start()">
		...
		<div class="nav">
			<div class="links">
				...
				<a onclick="news(this)" id="news" class="active">News</a>
        ...
        function start(){
                  document.getElementById("demo").style.display = "none";
                   ...
                   var codeBlock='<div class="head">'+
						'<i class="icon fa fa-newspaper-o" aria-hidden="true"></i><b class="head-text">   News</b>'+
						
					'</div>'+
					'<div class="packaging-div">'+
							
							'<label class=" headline-label">Headline:</label>'+
							'<input class="headline-input" type="text" name="news_headline" id="news_headline" placeholder="Enter your News Headline"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-news-headline"></span>'+
                            '</div>'+

							'<label class=" news-detail-label">News Detail:</label>'+
							'<input class="news-detail-input" type="text" name="news_detail" id="news_detail" placeholder="Enter detail of your News"  autocomplete="off" required="required"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-news-deyail"></span>'+
                            '</div>'+
							
							'<label class=" more-detail-label">For More Details:</label>'+
							'<input class="more-detail-input" type="text" name="news_more_detail" id="news_more_detail" placeholder="Enter site link for more detail"  autocomplete="off"> <br>'+
							'<div class="error-message-div">'+
					           '<span class="error-message" id="error-message-news-link"></span>'+
                            '</div>'+
							
					'</div>'+
					'<div class="generate-btn-div">'+
						'<input class="generate-btn" type="submit" value="Generate Qr Code" name="business_news" onclick="news_validate()"/>'+
					'</div>';
